        ...
        <div className='w-full lg:px-28 md:px-16 sm:px-7 px-4 mt-[13ch] mb-[10ch]'>
            <div className="w-full grid grid-cols-2 gap-16 items-center">
                <div className="col-span-1 space-y-8">
                    <img src={Bus} alt="Bus Detail Image" className="w-full aspect-[3/2] rounded-md object-contain"/>
                    <div className="space-y-4">
                        ...
                        <p className="text-neutral-900 dark:text-neutral-200 text-sm font-normal">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem, esse sint soluta veniam illum omnis laudantium nulla saepe necessitatibus sequi eos molestiae earum repellat suscipit vitae exercitationem voluptate corrupti. Repudiandae.
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque deleniti inventore nihil ad non dolor quibusdam laboriosam maxime at voluptatum itaque doloribus id ratione eum, quas quos, sequi similique ut?
                            </p>
                    </div>
                </div>
